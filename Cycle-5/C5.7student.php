<!--Php program to insert student details using mysql-->
<html>
<head></head>
...
<td><a href="C5.8student_update.php?id=<?php echo $res['id'];?>">Update</a></td>
<td><a href="C5.8student_delete.php?id=<?php echo $res['id'];?>">Delete</a></td>
</tr>
</table>
<?php
}
